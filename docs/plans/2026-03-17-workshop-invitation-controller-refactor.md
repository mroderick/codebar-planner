...
## Chunk 3: Update route helpers in controllers and views
...
- [ ] **Step 1: Check and update workshops_controller.rb**
...
- [ ] **Step 2: Check and update events_controller.rb**
...
After this refactor:
- `InvitationControllerConcerns` is inlined into the controller (deleted)
